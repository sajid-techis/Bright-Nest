...
const services = [
  {
    ...
    title: "3D Design",
    description:
      "Our 3D design services bring your ideas to life with detailed and realistic visualizations. This allows you to see your space before it’s built, helping you make informed decisions.", // Ensure proper escaping
    image: "/work-img.png",
  },
  {
  ...
  },
  {
    ...
    title: "Renovations",
    description:
      "Bright Nest offers comprehensive renovation services, transforming outdated spaces into stunning areas that meet modern standards and enhance your home&apos;s value.", // Escaped apostrophe
    image: "/work-img.png",
  },
  {
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-16">
          ...
          <p className="flex-1 text-sm md:text-base md:w-1/3">
            ...
            designers works closely with you to bring your dreams to life. {/* Escaped apostrophe */}
          </p>
        </div>
